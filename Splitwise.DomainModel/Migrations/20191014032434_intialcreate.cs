        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    activityOn = table.Column<string>(nullable: true),
                    activityOnId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    activityUserId = table.Column<string>(nullable: true),
                    log = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    expenseId = table.Column<string>(nullable: true),
                    userId = table.Column<string>(nullable: true),
                    creditedAmount = table.Column<float>(nullable: false),
                    debitedAmount = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
